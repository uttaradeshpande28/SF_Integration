  ...
  stages {
    ...
    stage('Build and Test') {
      steps {
        ...
        echo "1.."
        powershell 'C:\\Users\\Uttara\\AppData\\Local\\Programs\\Python\\Python38\\Scripts\\coverage run --source=. -m pytest test/'  // Run tests with code coverage using PowerShell with full path to coverage executable
        echo "2.."
      }
    }
